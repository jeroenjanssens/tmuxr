...
#> [1] "$ seq 100 |"                   "> grep 3 |"                   
#> [3] "> wc -l"                       "      19"                     
#> [5] "$ date"                        "Mon Sep  4 15:11:40 CEST 2017"
kill_session(s)
```
...
list_sessions()
#> [[1]]
#> tmuxr session docker_R: 1 windows (created Mon Sep  4 15:11:41 2017) [80x23]
#> [[2]]
#> tmuxr session python: 1 windows (created Mon Sep  4 15:11:43 2017) [80x23]
kill_server()
#> character(0)
```
